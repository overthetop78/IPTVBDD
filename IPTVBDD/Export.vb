...
Module Export
    ...
    Public Sub ExportM3U(ByVal Exp As Integer)
        Select Case Exp
            ...
            Case 2
                'Création du fichier M3U avec seulement les  Chaines Actives
                'On doit lire la base de données et récuperer toutes les chaines Actives
                ...
                SQLCommand.CommandText = $"SELECT * FROM '{Adresse}' ORDER BY NoChaine ASC,NoCanal ASC;"
